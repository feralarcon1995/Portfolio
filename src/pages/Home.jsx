        ...
        <div className="left">
          <div className="left-top">
            ...
            <div className="descriptions">
              ...
              >Hi, I'm Fernando Alarcón based in Argentina. I'm always looking for new challenges in a development team, where I can add value from my experience and knowledge in the Front-End area, and keep learning every day. At the same time, I am a beginner in cybersecurity and I study English to improve my skills in the working field.</motion.p>
            </div>
          </div>
          <div className="left-bottom">
            <motion.a
              variants={opacityReveal} initial="initial"
              animate="animate"
              transition={{ ...transition, duration: 1, delay: 3.7 }}
            ...
            <motion.a
              variants={opacityReveal} initial="initial"
              animate="animate"
              transition={{ ...transition, duration: 1, delay: 3.9 }}
